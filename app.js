import { initFirebase, isFirebaseConfigured, signIn, signOutUser, observeAuth, fetchSongs, saveSong, updateSongParts, updateSongMetadata, deleteSong, analyzeSongPdf, applySongAnalysis } from "./firebase.js?v=8";
